...
class OptionsSubState extends MusicBeatSubstate
{
	...
	//any of these commented out its because you shouldnt change them mid game
	//dont try it literally nothing happens
	...
	override function create()
	{
		...
		bg = new FlxSprite(0,0).loadGraphic(Paths.image("menuBGDesat"));
		bg.color = 0xFF666666;
		bg.scrollFactor.set();
		add(bg);
