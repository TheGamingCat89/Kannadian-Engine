...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		#if sys	if (FileSystem.exists(Paths.json("characters/" + character)))#end
					charData = Json.parse(Assets.getText(Paths.json("characters/" + character))); //this should work RIGHT??
		#if sys	else
					charData = Json.parse(Assets.getText(Paths.json("characters/dad")));#end

				iconColor = FlxColor.fromString(charData.icon.color);

				tex = Paths.getSparrowAtlas('characters/${charData.path}', 'shared');
...
typedef CharacterData = {
	var name:String;
	var animations:Array<{name:String,prefix:String,offset:Array<Float>,looped:Bool,frameRate:Int}>;//not necessary but whatever
	var path:String;
	var icon:{icon:String,color:String};
	var flipped:Bool;
